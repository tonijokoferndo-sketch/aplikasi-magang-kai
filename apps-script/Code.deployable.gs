// Deployment copy: this file is prefilled with the MAIN/ADMIN spreadsheet IDs
// from the repository's Code.gs. Replace the IDs if you want to use different
// spreadsheets before saving and deploying.
...
(The attachment is truncated here.)
```